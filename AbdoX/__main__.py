...
async def init():
    ...
    LOGGER("ســــــورس هانتر").info("Yosr3456")
    await idle()
    await app.stop()
    await userbot.stop()
    LOGGER("ســــــورس هانتر").info("جارِ ايقاف بوت الميوزك . . .")
