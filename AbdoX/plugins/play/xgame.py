...
GAME_MESSAGE = "⩹━★⊷━⌞𝐒𝐎𝐔𝐑𝐂𝐄 𝑯𝑼𝑵𝑻𝑬𝑹\n\n★¦ مرحبا بك عزيزي:\n★¦في قسم العاب هــــانتر\n\n⩹━★⊷━⌞𝐒𝐎𝐔𝐑𝐂𝐄 𝑯𝑼𝑵𝑻𝑬𝑹"
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
        InlineKeyboardButton ('𝐒𝐎𝐔𝐑𝐂𝐄 𝑯𝑼𝑵𝑻𝑬𝑹', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('⌞𝐒𝐎𝐔𝐑𝐂𝐄 𝑯𝑼𝑵𝑻𝑬𝑹', url =f"https://t.me/huntersource")              
                 ],[
...
async def zohary(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://te.legra.ph/file/f0ed9f1cfe7aa338c4a18.jpg",
...
async def callback_query(client, CallbackQuery):
          if CallbackQuery.data == "GAME1":
             ...
             GAME1_MESSAGE = "⩹━★⊷━⌞𝐒𝐎𝐔𝐑𝐂𝐄 𝑯𝑼𝑵𝑻𝑬𝑹\n\nمرحبا بك في قسم العاب هــــانتر 3D\n\n⩹━★⊷━⌞𝐒𝐎𝐔𝐑𝐂𝐄 𝑯𝑼𝑵𝑻𝑬𝑹"
             ...
             await CallbackQuery.edit_message_text( 
               ...
               RETURN_GAME = "⩹━★⊷━𝐒𝐎𝐔𝐑𝐂𝐄 𝑯𝑼𝑵𝑻𝑬𝑹\n\n★¦مرحبا بك في قسم العاب هــــانتر\n★¦اختار ما تشاء من الالعاب مسليه وستمتع بها\n\n⩹━★⊷━⌞𝐒𝐎𝐔𝐑𝐂𝐄 𝑯𝑼𝑵𝑻𝑬𝑹" 

               RETURN_BUTTON = [
                    [ 
                      InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
                      InlineKeyboardButton ('★¦العاب هــــانتر', callback_data= 'GAME2')
                      ],[
        InlineKeyboardButton ('⌞𝐒𝐎𝐔𝐑𝐂𝐄 𝑯𝑼𝑵𝑻𝑬𝑹', url =f"https://t.me/huntersource")              
                 ],[
                InlineKeyboardButton(
