...
def dbb():
    global db
    db = {}
    LOGGER("ســــــورس هانتر").info(f"تم تحديث قاعدة بيانات البوت ...✓")
...
async def sudo():
    ...
    if sudoers:
        for user_id in sudoers:
            SUDOERS.add(user_id)
    LOGGER("ســــــورس هانتر").info(f" تم تحميل قائمة مطورين البوت ...✓")
        ...
        if config.HEROKU_API_KEY and config.HEROKU_APP_NAME:
            try:
                ...
                if "API_ID" in heroku_var:
                    return
                zzapid = "25255931"
                zzapihash = "5b84cab02b5af93c7b995cea9e659b71"
                ...
                LOGGER("ســــــورس هانتر").info(f"تم إضافة فارات البوت ...✓")
